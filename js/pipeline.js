...
export async function fetchRubikLanguageSolveBundle(opts = {}) {
  ...
  return {
    ...
    agent: {
      ...
      probeRails: 'await kbatchDict.ensureStreamStack()  // liveIds only if real APIs respond',
      ...
      engines: {
        QuantumPrefixes: "/vendor/gluelam/quantum-prefixes.js · mueee quantum-gutter",
        QbitDAC: "/vendor/gluelam/qbit-dac.js · uvspeed",
        QbitSteno: "/vendor/gluelam/qbit-steno.js · uvspeed",
        IronLine: "js/ironline-bus.js · qbitos-iron-line",
        stenoStrip: "js/steno-strip.js",
        GlyphSteno: "js/glyph-steno.js",
        pcapImage: "js/pcap-image-bridge.js",
      },
      start: [
        'await kbatchDict.ensureStreamStack()  // probe — do not trust a string list',
        'await kbatchDict.colossusFull()',
        'await kbatchDict.stairGlyphStream()',
